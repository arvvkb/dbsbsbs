...
import os
token = '7087804236:AAFV5ul-YPXbeXNH6DUzY6chxui_TDlDDAg'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber ='2095495680'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '2095495680':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @T4_Mohamed")
		return
...
𝒃𝒚 ➜ @T4_Mohamed ''', reply_markup=mes)
				msg = f'''◆ 𝑪𝑨𝑹𝑫  ➜ {cc} 
◆ 𝑺𝑻𝑨𝑻𝑼𝑺 ➜ 𝗔𝗽𝗽𝗿𝗼𝘃𝗲𝗱  ✅ 
◆ 𝑹𝑬𝑺𝑼𝑳𝑻 ➜ #Approved
